...
while True:
    ...
    if faceCurFrame:
        ...
        for encodeFace, faceLoc in zip(encodeCurFrame, faceCurFrame):
            ...
            # print("match index", matchIndex) # shows the index VERY usefull

            if matches[matchIndex]:
                # print("known face detected")   #prints the text and student id
                ...
                if counter == 0:
                    ...
                    cv2.imshow("MARKMYFACE", imgBackGround)
                    cv2.waitKey(1)
                    counter = 1
                    modeType = 1
            ...
            if counter != 0 :
                ...
                if counter == 1:
                    ...
                    if secondsElapsed >30:              #####how many hours we need to set the period
